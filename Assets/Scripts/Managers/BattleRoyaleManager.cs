...
public class BattleRoyaleManager : SingletonMB<BattleRoyaleManager>
{
	...
	private const string						c_SandboxingCheatKey = "ENABLE_SANDBOXING";
	...
	private bool								m_EnableSandboxing;

	public bool									EnableSandboxing => m_EnableSandboxing;
    ...
    IEnumerator CountDownStart()
    {
        ...
        m_IsPlaying = true;
		m_EnableSandboxing = CheatManager.GetCheatStatus(c_SandboxingCheatKey);
